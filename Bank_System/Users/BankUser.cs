...
namespace Bank_System
{
    internal class BankUser : MainUser
    {
        ...
        public BankUser(string name, string login, string pass, string phoneNumb, string id, DateTime date) : base(login, pass)
        {
            FullName = name;
            BDate = date;
        ...
        {
            return $"ID:{ID}\nUser full name: {FullName}\n{base.ToString()}\nUser birthday: {BDate.Date.ToShortDateString()}\nPhone number: {PhoneNumber}";
        }
